package com.wanggebao.wgb.commonsdk.location;
...
public class LocationService extends NotiService {
    ...
    void startLocation() {
        ...
        // 每10分钟定位一次
        mLocationOption.setInterval(1 * 6 * 1000);
        // 地址信息
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        private void sendLocationBroadcast(AMapLocation aMapLocation) {
            ...
            if (null == aMapLocation) {
                ...
                //上报坐标
                //uploadLocation(String.valueOf(longitude),String.valueOf(latitude));
                sb.append(Utils.getLocationStr(aMapLocation));
            }
            Log.e("location",sb.toString());
            Intent mIntent = new Intent("location_in_background");
